  ...
  return (
    ...
    >
      <div className="app-wrapper w-full h-full flex flex-col justify-start items-center relative mx-auto">
        ...
        <div className="app-main-container relative grow flex flex-col items-center justify-center gap-[40px] w-auto h-auto pt-0 sm:pt-[70px] scale-75 sm:scale-100 md:scale-110 md:-translate-y-[2%] lg:scale-115 lg:-translate-y-[3%] xl:scale-125 xl:-translate-y-[5%] 2xl:scale-[1.4] 2xl:-translate-y-[8%] transition-transform duration-300 ease-in-out z-10">
        ...
        <div className="app-bottom-container relative grow-0 h-auto flex items-end justify-center w-full scale-75 sm:scale-100 md:scale-110 md:-translate-y-[2%] lg:scale-115 lg:-translate-y-[3%] xl:scale-125 xl:-translate-y-[5%] 2xl:scale-[1.4] 2xl:-translate-y-[8%] transition-transform duration-300 ease-in-out">
